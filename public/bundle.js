...
var IndecisionApp = function (_Component) {
  ...
  _createClass(IndecisionApp, [{
    ...
    value: function handleAddOption(option) {
      var result = void 0;
      var isValid = !this.state.options.includes(option);
      if (isValid) {
        result = 'valid';
        var options = this.state.options.concat(option);
    ...
    value: function handleDecision() {
      ...
      var decision = Math.floor(Math.random() * length);
    ...
    key: 'handleRemoveOne',
    value: function handleRemoveOne(idx) {
  ...
  _createClass(Actions, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        this.props.hasOptions && _react2.default.createElement(
          'button',
...
var Option = function (_Component) {
  ...
  function Option(props) {
    ...
    _this.initiateRemoval = _this.initiateRemoval.bind(_this);
    return _this;
  }

  _createClass(Option, [{
    key: 'initiateRemoval',
    value: function initiateRemoval() {
...
var AddOption = function (_Component) {
  ...
  function AddOption(props) {
    ...
    _this.initiateAddOption = _this.initiateAddOption.bind(_this);
    _this.evaluateButtonState = _this.evaluateButtonState.bind(_this);
    _this.state = {
      error: null,
      buttonDisabled: true
    };
  ...
  _createClass(AddOption, [{
    key: 'initiateAddOption',
    value: function initiateAddOption(e) {
      e.preventDefault();
      var error = void 0,
          buttonDisabled = void 0;
      var option = e.target.elements.option.value;
      var result = this.props.handleAddOption(option);
      if (result === 'valid') {
      ...
      this.setState(function () {
        return { error: error, buttonDisabled: buttonDisabled };
      });
    }
  }, {
    key: 'evaluateButtonState',
    value: function evaluateButtonState(e) {
      var optionText = e.target.value;
      var buttonDisabled = void 0;
      optionText.length === 0 ? buttonDisabled = true : buttonDisabled = false;
      this.setState(function () {
        return { buttonDisabled: buttonDisabled };
      });
    }
  }, {
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        'form',
        { onSubmit: this.initiateAddOption },
        _react2.default.createElement('input', { type: 'text', name: 'option', onChange: this.evaluateButtonState }),
